                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                <input id="searchInput" type="text" class="form-control border-start-0 ps-0"
                                    placeholder="Filtrar por nombre, apellido o correo..." name="search"
                                    value="<?php echo e(request()->search); ?>" data-table-filter="teachersTable">
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <table class="table table-striped table-hover align-middle mb-0" id="teachersTable">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $profesores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profesor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td class="pe-3 text-end actions-container">
                                            <div class="action-buttons">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-info" data-bs-toggle="modal"
                                                    data-bs-target="#verProfesorModal<?php echo e($profesor->Id_profesores); ?>"
                                                    title="Ver detalles">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                                                    data-bs-target="#editarProfesorModal<?php echo e($profesor->Id_profesores); ?>"
                                                    title="Editar">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>

                                                <!-- Eliminar -->
                                                <form action="<?php echo e(route('profesores.destroy', $profesor->Id_profesores)); ?>"
                                                    method="POST"
                                    ...
                                    <!-- Modal Ver Profesor -->
                                    <div class="modal fade" id="verProfesorModal<?php echo e($profesor->Id_profesores); ?>" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header bg-info text-white">
                                                    <h5 class="modal-title"><i class="bi bi-person-lines-fill me-2"></i>Detalles del
                                                        Profesor</h5>
                                    ...
                                    <div class="modal fade" id="editarProfesorModal<?php echo e($profesor->Id_profesores); ?>" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header bg-primary text-white">
                                                    <h5 class="modal-title"><i class="bi bi-pencil-square me-2"></i>Editar Profesor
                                                    </h5>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal"></button>
                                                </div>
                                                <form action="<?php echo e(route('profesores.update', $profesor->Id_profesores)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" name="nombre" class="form-control"
                                                                    value="<?php echo e($profesor->persona->Nombre ?? ''); ?>" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label fw-bold">Apellido</label>
                                                                <input type="text" name="apellido" class="form-control"
                                                                    value="<?php echo e($profesor->persona->Apellido ?? ''); ?>" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label fw-bold">Celular</label>
                                                                <input type="text" name="celular" class="form-control"
                                                                    value="<?php echo e($profesor->persona->Celular ?? ''); ?>">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label fw-bold">Correo electrónico</label>
                                                                <input type="email" name="correo" class="form-control"
                                                                    value="<?php echo e($profesor->usuario->Correo ?? ''); ?>" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label fw-bold">Nueva contraseña
                                                                    (opcional)</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" name="profesion" class="form-control"
                                                                    value="<?php echo e($profesor->Profesion ?? ''); ?>">
                                                            </div>
                                                            <div class="col-md-6">
...
<?php $__env->stopSection(); ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DANTE\Desktop\YebSis\resources\views/administrador/profesoresAdministrador.blade.php ENDPATH**/ ?>