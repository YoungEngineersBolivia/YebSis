...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Hola<?php echo e(isset($usuario->Nombre) ? ', ' . $usuario->Nombre : ''); ?>!</h2>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e($resetUrl); ?>" class="button">
            ...
            <div class="info-box">
                ...
                <p style="margin: 10px 0 0 0; word-break: break-all; font-size: 12px;">
                    <a href="<?php echo e($resetUrl); ?>" style="color: #007bff;"><?php echo e($resetUrl); ?></a>
                </p>
            </div>
        ...
        <div class="footer">
            ...
            <p>© <?php echo e(date('Y')); ?> Jóvenes Ingenieros. Todos los derechos reservados.</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\danil\Desktop\Laravel\Yebolivia\resources\views/emails/password_reset.blade.php ENDPATH**/ ?>