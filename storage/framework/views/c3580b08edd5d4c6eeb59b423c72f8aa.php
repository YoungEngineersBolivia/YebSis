<?php $__env->startSection('title', 'Modelos del Programa'); ?>
...
<div class="container-fluid py-4">
    ...
    <div class="programa-header">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <a href="<?php echo e(route('programas.index')); ?>" class="btn btn-back mb-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <span class="info-badge">
                        ...
                        <?php echo e($programa->Tipo === 'programa' ? 'Programa' : 'Taller'); ?>

                    </span>
                    <span class="info-badge">
                        <i class="bi bi-people-fill"></i>
                        <?php echo e($programa->Rango_edad); ?>

                    </span>
                    <span class="info-badge">
                        <i class="bi bi-clock-fill"></i>
                        <?php echo e($programa->Duracion); ?>
        ...
        <div class="stats-card">
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <h3 class="stats-value"><?php echo e($modelos->count()); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="stats-card">
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <h3 class="stats-value"><?php echo e($modelos->where('created_at', '>=', now()->startOfMonth())->count()); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="stats-card">
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <h3 class="stats-value"><?php echo e($modelos->count() > 0 ? 'Activo' : 'Sin Modelos'); ?></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php else: ?>
        <div class="modelos-grid">
            ...
            <div class="modelo-card">
                ...
                <h6><?php echo e($modelo->Nombre_modelo); ?></h6>
                ...
                <div class="modelo-actions">
                    <button type="button" 
                            ...
                            onclick="editarModelo(<?php echo e($programa->Id_programas); ?>, <?php echo e($modelo->Id_modelos); ?>)"
                            title="Editar">
                        <i class="bi bi-pencil-fill me-1"></i>Editar
                    </button>
                    <button type="button" 
                            class="btn btn-sm btn-outline-danger" 
                            onclick="eliminarModelo(<?php echo e($programa->Id_programas); ?>, <?php echo e($modelo->Id_modelos); ?>)"
                            title="Eliminar">
...
<div class="modal fade" id="nuevoModeloModal" tabindex="-1" aria-labelledby="nuevoModeloLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="formNuevoModelo" action="<?php echo e(route('modelos.store', $programa->Id_programas)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               required 
                               value="<?php echo e(old('nombre_modelo')); ?>">
                        <div class="form-text">Ingresa un nombre descriptivo para el modelo</div>
                    </div>
                    <div class="alert alert-info mb-0">
                        <i class="bi bi-info-circle-fill me-2"></i>
                        <strong>Programa:</strong> <?php echo e($programa->Nombre); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danil\Desktop\Laravel\Yebolivia\resources\views/administrador/modelosPrograma.blade.php ENDPATH**/ ?>