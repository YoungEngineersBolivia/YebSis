    ...
    <div class="container-fluid py-4">
            ...
            <div class="col-12">
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div>
                            <h1>
                                <i class="fas fa-graduation-cap me-2" style="color: var(--primary-color);"></i>Gestión de
                                Programas
                            </h1>
                        ...
                        <button type="button" class="btn btn-primary btn-lg shadow" data-bs-toggle="modal"
                            data-bs-target="#nuevoProgramaModal">
        ...
        <?php if(session('error')): ?>
            <div class="alert alert-danger alert-modern alert-dismissible fade show border-0 shadow-sm d-flex align-items-center p-3 mb-4"
                ...
                <div class="flex-grow-1">
                    <h6 class="alert-heading mb-1 fw-bold text-danger" style="font-size: 0.95rem;">Error del Sistema</h6>
        ...
        <?php if($errors->any()): ?>
            <div class="alert alert-danger alert-modern alert-dismissible fade show border-0 shadow-sm d-flex align-items-start p-3 mb-4"
                role="alert"
                style="background: linear-gradient(to right, #fee2e2, #fef2f2); border-left: 5px solid #f97316 !important;">
                <div class="alert-icon-circle bg-warning text-white rounded-circle d-flex align-items-center justify-content-center me-3"
                    style="width: 40px; height: 40px; min-width: 40px;">
                    <i class="fas fa-exclamation-triangle"></i>
                </div>
                <div class="flex-grow-1">
                    <h6 class="alert-heading mb-1 fw-bold text-danger" style="font-size: 0.95rem;">Corrija lo siguiente:</h6>
                    <ul class="mb-0 ps-3 text-danger-emphasis" style="font-size: 0.85rem;">
        ...
        <div class="row mb-4">
            <div class="col-lg-6 col-md-12 mb-3 mb-lg-0">
                <div class="input-group input-group-lg search-box">
                    ...
                    <input type="text" class="form-control" placeholder="Buscar por nombre, tipo o descripción..."
                        id="searchInput">
                </div>
            </div>
                                            ...
                                            <tr data-tipo="<?php echo e($programa->Tipo); ?>">
                                                <td class="ps-4 fw-semibold">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <small
                                                            class="text-muted"><?php echo e(Str::limit($programa->Descripcion, 40)); ?></small>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-sm btn-outline-primary"
                                                        ...
                                                        <span
                                                            class="badge bg-primary rounded-pill"><?php echo e($programa->modelos_count ?? 0); ?></span>
                                                    </button>
                                                </td>
                                                <td class="text-center">
                    ...
                    <div class="col-12 program-card-wrapper" data-tipo="<?php echo e($programa->Tipo); ?>">
                        <div class="program-card">
                            ...
                            <div class="program-card-actions">
                                ...
                                <form action="<?php echo e(route('programas.destroy', $programa->Id_programas)); ?>" method="POST"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control" name="nombre" placeholder="Ej: Robotica Educativa"
                                    required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="duracion" placeholder="Ej: 3 meses / 8 clases"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">
                                ...
                                <input type="number" class="form-control" name="costo" step="0.01" placeholder="0.00"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">
                                ...
                                <input type="text" class="form-control" name="rango_edad" placeholder="Ej: 6-12 años"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="descripcion" rows="4"
                                placeholder="Describe el contenido y objetivos del programa..." required></textarea>
                        </div>
        ...
        <div class="modal fade" id="editarProgramaModal<?php echo e($programa->Id_programas); ?>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('programas.update', $programa->Id_programas)); ?>" method="POST"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nombre" value="<?php echo e($programa->Nombre); ?>"
                                        required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="duracion" value="<?php echo e($programa->Duracion); ?>"
                                        required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">
                                    ...
                                    <input type="number" class="form-control" name="costo" step="0.01"
                                        value="<?php echo e($programa->Costo); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">
                                        <i class="fas fa-users me-1"></i>Rango de Edad
                                    </label>
                                    <input type="text" class="form-control" name="rango_edad"
                                        value="<?php echo e($programa->Rango_edad); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="duracion"
                                        value="<?php echo e($programa->Duracion ?? ''); ?>" placeholder="Ej: 3 meses, 12 semanas, 40 horas">
                                    <small class="text-muted">
                            ...
                            <div class="mb-3">
                                ...
                                <?php if($programa->Imagen): ?>
                                    <div class="mt-3 p-3 bg-light rounded">
                                        ...
                                        <img src="<?php echo e(asset('storage/' . $programa->Imagen)); ?>" class="img-thumbnail"
                                ...
                                <div class="list-group">
                                    <?php $__currentLoopData = $modelosPrograma; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modelo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <form
                                                action="<?php echo e(route('modelos.destroy', [$programa->Id_programas, $modelo->Id_modelos])); ?>"
                                                method="POST" style="display:inline;"
                                                onsubmit="return confirm('¿Estás seguro de eliminar este modelo?')">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit" class="btn btn-sm btn-outline-danger" title="Eliminar modelo">
                                                    <i class="bi bi-trash3-fill"></i>
                                                </button>
                                            </form>
                                        </div>
                            ...
                            <form action="<?php echo e(route('modelos.store', $programa->Id_programas)); ?>" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nombre_modelo"
                                        placeholder="Ej: Modelo 1, Modelo Básico, etc." required>
                                </div>
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary">
