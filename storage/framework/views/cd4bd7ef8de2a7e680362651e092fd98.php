...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Panel del Tutor'); ?> - Young Engineers</title>
...
<body>
            ...
            <nav class="nav-links" id="mainNavLinks">
                ...
                <div class="user-dropdown">
                    ...
                    <div class="dropdown-menu-custom" id="dropdownMenu">
                        <div class="dropdown-item-custom" onclick="window.location.href='<?php echo e(route('tutor.home')); ?>'">
                            🏠 Inicio
                        </div>
    ...
    <div class="main-content">
        ...
        <?php if(Route::currentRouteName() === 'tutor.home'): ?>
...
</html><?php /**PATH C:\Users\danil\Desktop\Laravel\Yebolivia\resources\views/tutor/baseTutor.blade.php ENDPATH**/ ?>