...
<?php $__env->startSection('content'); ?>
  <div class="container-fluid mt-4">
    ...
    <div class="card shadow-sm border-0 mb-3">
      <div class="card-body">
        <form action="<?php echo e(route('horarios.index')); ?>" method="GET" id="searchForm">
          <div class="row g-3">
            <div class="col-12">
              <div class="input-group">
                <span class="input-group-text bg-white"><i class="bi bi-search"></i></span>
                <input type="text" class="form-control" id="searchInput" name="search" value="<?php echo e($search ?? ''); ?>"
                  placeholder="Buscar por nombre del estudiante..." autocomplete="off">
                <?php if($search): ?>
                  <a href="<?php echo e(route('horarios.index')); ?>" class="btn btn-outline-secondary">
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        ...
        if (searchInputGlobal) {
            ...
            const totalRows = <?php echo e($horarios->total()); ?>;
