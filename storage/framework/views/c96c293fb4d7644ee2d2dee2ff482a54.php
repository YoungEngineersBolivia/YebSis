...
<?php $__env->startSection('title', 'Historial de Egresos'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="page-header d-flex flex-wrap justify-content-between align-items-center gap-3">
        ...
        <div class="d-flex align-items-center gap-3">
            <form action="<?php echo e(route('egresos.mensuales')); ?>" method="GET" class="d-flex align-items-center gap-2">
                <label class="text-muted small fw-bold text-uppercase mb-0">Filtrar Año:</label>
                <select name="anio" class="form-select form-select-sm shadow-sm" style="width: 100px;"
                    onchange="this.form.submit()">
                    <?php for($a = 2023; $a <= Carbon\Carbon::now()->year + 1; $a++): ?>
                        <option value="<?php echo e($a); ?>" <?php echo e($anioSeleccionado == $a ? 'selected' : ''); ?>><?php echo e($a); ?></option>
                    <?php endfor; ?>
                </select>
                <a href="<?php echo e(route('egresos.mensuales')); ?>" class="btn btn-sm btn-outline-secondary shadow-sm"
            ...
            <a href="<?php echo e(route('egresos.index')); ?>" class="btn btn-primary shadow-sm">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover table-striped align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $egresosMensuales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $egreso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="ps-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <span class="fw-bold text-capitalize"><?php echo e($egreso->nombre_mes); ?></span>
                                            <span class="text-muted ms-1"><?php echo e($egreso->anio); ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <a href="<?php echo e(route('egresos.index', ['mes' => $egreso->mes, 'anio' => $egreso->anio])); ?>"
                                        class="badge bg-info text-white rounded-pill px-3 text-decoration-none hover-shadow"
                                        title="Ver detalles de estos egresos">
                                        <?php echo e($egreso->cantidad_egresos); ?> registros <i class="bi bi-eye ms-1"></i>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <span class="fw-bold text-danger fs-5">
                                        Bs. <?php echo e(number_format($egreso->total, 2, '.', ',')); ?>
                                ...
                                <td class="pe-4 text-end">
                                    <small class="text-muted">
                                        ...
                                        <?php echo e(\Carbon\Carbon::parse($egreso->ultima_fecha)->format('d/m/Y H:i')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DANTE\Desktop\YebSis\resources\views/administrador/egresosMensuales.blade.php ENDPATH**/ ?>