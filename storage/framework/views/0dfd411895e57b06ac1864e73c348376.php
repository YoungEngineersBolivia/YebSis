                    ...
                    <table class="table table-striped table-hover align-middle mb-0" id="teachersTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-light text-dark border"><?php echo e($profesor->Rol_componentes ?? 'Ninguno'); ?></span></td>
                                        ...
                                        <div class="modal-body">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="fs-5"><?php echo e($profesor->Profesion ?? ''); ?></div>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="fw-bold text-muted small">Rol Componentes</label>
                                                    <div class="fs-5"><?php echo e($profesor->Rol_componentes ?? ''); ?></div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DANTE\Desktop\Laravel\YebSis\resources\views/administrador/profesoresAdministrador.blade.php ENDPATH**/ ?>