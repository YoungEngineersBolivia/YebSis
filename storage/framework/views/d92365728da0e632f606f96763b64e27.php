...
<?php $__env->startSection('content'); ?>
    ...
    <div class="action-footer d-flex justify-content-center gap-3 flex-wrap">
        <a href="<?php echo e(route('estudiantes.planesPago', $estudiante->Id_estudiantes)); ?>" class="btn btn-primary">
            <i class="bi bi-cash-stack"></i> Planes de Pago
        </a>
        <a href="<?php echo e(route('estudiantes.evaluaciones', $estudiante->Id_estudiantes)); ?>" class="btn btn-info text-white">
            <i class="bi bi-clipboard-check-fill"></i> Evaluaciones
        </a>
        <form action="<?php echo e(route('estudiantes.cambiarEstado', $estudiante->Id_estudiantes)); ?>" method="POST"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DANTE\Desktop\YebSis\resources\views/administrador/detallesEstudiante.blade.php ENDPATH**/ ?>