    ...
    <div class="mt-2 text-start">
        ...
        <div class="row mb-4">
            <div class="col-12 text-center">
                <div class="btn-group w-100 d-flex flex-wrap" role="group" aria-label="Tipo de acción">
                    <input type="radio" class="btn-check" name="tipoAccion" id="optionPublicacion" value="publicacion"
                        autocomplete="off" <?php echo e(old('form_type', 'publicacion') == 'publicacion' ? 'checked' : ''); ?>>
                    <label class="btn btn-outline-primary flex-fill mb-2 mb-md-0" for="optionPublicacion"><i
                            class="bi bi-globe me-2"></i>Gestión de Publicaciones</label>

                    <input type="radio" class="btn-check" name="tipoAccion" id="optionNotificacion" value="notificacion"
                        autocomplete="off" <?php echo e(old('form_type') == 'notificacion' ? 'checked' : ''); ?>>
                    <label class="btn btn-outline-warning flex-fill mb-2 mb-md-0" for="optionNotificacion"><i
                            class="bi bi-envelope-paper me-2"></i>Gestión de Notificaciones</label>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-header bg-white border-bottom-0 pt-3 ps-3">
                        <h5 class="card-title fw-bold text-primary mb-0"><i class="bi bi-plus-circle me-2"></i>Nueva
                            Publicación</h5>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('publicaciones.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control" required
                                    placeholder="Título de la publicación" value="<?php echo e(old('nombre')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="descripcion" id="descripcion" rows="4" class="form-control" required
                                    placeholder="Contenido de la publicación"><?php echo e(old('descripcion')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary"><i
                                        class="bi bi-send me-1"></i>Publicar</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-8 mb-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-header bg-white border-bottom-0 pt-3 ps-3">
                        <h5 class="card-title fw-bold text-secondary mb-0"><i class="bi bi-list-ul me-2"></i>Publicaciones
                            Web Activas</h5>
                    </div>
                            ...
                            <table class="table table-striped table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $publicaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="ps-3 fw-semibold"><?php echo e($pub->Nombre); ?></td>
                                            <td><?php echo e(Str::limit($pub->Descripcion, 50)); ?></td>
                                            <td>
                                                <?php if($pub->Imagen): ?>
                                                    <a href="<?php echo e(asset('storage/' . $pub->Imagen)); ?>" target="_blank"
                                            ...
                                            <td><?php echo e($pub->created_at ? $pub->created_at->format('d/m/Y') : 'N/A'); ?></td>
                                            <td class="pe-3 text-end">
                                                <form action="<?php echo e(route('publicaciones.destroy', $pub->Id_publicaciones)); ?>"
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="5" class="text-center py-4 text-muted">No hay publicaciones aún.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
        ...
        <div id="sectionNotificacion" class="row" style="display: none;">
            ...
            <div class="col-lg-5 mb-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-header bg-white border-bottom-0 pt-3 ps-3">
                        <h5 class="card-title fw-bold text-warning mb-0"><i class="bi bi-broadcast me-2"></i>Nueva
                            Notificación</h5>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('notificaciones.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre" id="nombre_notif" class="form-control" required
                                    placeholder="Asunto de la notificación" value="<?php echo e(old('nombre')); ?>">
                                <?php $__errorArgs = ['nombre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="descripcion" id="descripcion_notif" rows="3" class="form-control" required
                                    placeholder="Mensaje para los tutores"><?php echo e(old('descripcion')); ?></textarea>
                                <?php $__errorArgs = ['descripcion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="imagen" id="imagen_notif" class="form-control"
                                    accept="image/*,application/pdf">
                                <?php $__errorArgs = ['imagen'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-2 mb-2">
                                    <input type="radio" class="btn-check" name="filtroDestinatarios" id="filtroTodos"
                                        value="todos" <?php echo e(old('filtroDestinatarios', 'todos') == 'todos' ? 'checked' : ''); ?>>
                                    ...
                                    <input type="radio" class="btn-check" name="filtroDestinatarios" id="filtroActivos"
                                        value="activos" <?php echo e(old('filtroDestinatarios') == 'activos' ? 'checked' : ''); ?>>
                                    ...
                                    <input type="radio" class="btn-check" name="filtroDestinatarios" id="filtroInactivos"
                                        value="inactivos" <?php echo e(old('filtroDestinatarios') == 'inactivos' ? 'checked' : ''); ?>>
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" id="buscador-tutor" class="form-control"
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label small" for="select-all-tutores">Seleccionar
                                            visibles</label>
                                    </div>
                                    <span class="badge bg-secondary" id="contador-seleccionados">0 seleccionados</span>
                                </div>

                                <div id="lista-tutores" class="border rounded p-2 bg-light"
                                    ...
                                    <?php $__currentLoopData = $tutores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <div class="form-check tutor-item border-bottom py-1"
                                            data-activo="<?php echo e($esActivo ? 'true' : 'false'); ?>">
                                            <input class="form-check-input tutor-checkbox" type="checkbox" name="tutores[]"
                                                value="<?php echo e($tutor->Id_tutores); ?>" id="tutor-<?php echo e($tutor->Id_tutores); ?>" <?php echo e($isChecked ? 'checked' : ''); ?>>
                                            <label class="form-check-label d-flex justify-content-between w-100 pe-1"
                                                for="tutor-<?php echo e($tutor->Id_tutores); ?>" style="cursor: pointer;">
                                                <span class="text-truncate"><?php echo e($tutor->persona->Nombre ?? ''); ?>

                                                    <?php echo e($tutor->persona->Apellido ?? ''); ?></span>
                                                <?php if($esActivo): ?>
                                                    <i class="bi bi-circle-fill text-success" title="Activo"
                                                        style="font-size: 0.5rem; margin-top: 6px;"></i>
                                                <?php endif; ?>
                                            </label>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <?php $__errorArgs = ['tutores'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-warning text-white"><i
                                        class="bi bi-send me-1"></i>Enviar Notificación</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-7 mb-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-header bg-white border-bottom-0 pt-3 ps-3">
                        <h5 class="card-title fw-bold text-secondary mb-0"><i class="bi bi-clock-history me-2"></i>Historial
                            de Envíos</h5>
                    </div>
                    <div class="card-body p-0">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $notificaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li class="list-group-item p-3">
                                    <div class="d-flex justify-content-between mb-1">
                                        <h6 class="mb-0 fw-bold text-dark"><?php echo e($notif->Nombre); ?></h6>
                                        <span
                                            class="badge bg-light text-muted border"><?php echo e(\Carbon\Carbon::parse($notif->Fecha)->format('d/m/Y')); ?></span>
                                    </div>
                                    <p class="mb-0 text-muted small"><?php echo e($notif->Descripcion); ?></p>
                                    <?php if($notif->Imagen): ?>
                                        <div class="mt-2">
                                            <a href="<?php echo e(asset('storage/' . $notif->Imagen)); ?>" target="_blank"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DANTE\Desktop\YebSis\resources\views/administrador/pubnotAdministrador.blade.php ENDPATH**/ ?>