                            ...
                            <table class="table table-hover align-middle" id="tablaProximas">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $citasProximas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr class="cita-card <?php echo e($claseEstado); ?>" 
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fw-bold"><?php echo e($cita->estudiante->persona->Nombre ?? ''); ?> <?php echo e($cita->estudiante->persona->Apellido ?? ''); ?></div>
                                            ...
                                            <td>
                                                ...
                                                <div class="text-muted"><?php echo e(\Carbon\Carbon::parse($cita->Hora)->format('H:i')); ?></div>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <?php if($cita->estado == 'pendiente'): ?>
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-outline-danger"
                                                                onclick="cancelarCita(<?php echo e($cita->Id_citas); ?>)"
                                                                title="Cancelar cita">
                                    ...
                                    <?php $__currentLoopData = $citasPasadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr class="cita-card <?php echo e($claseEstado); ?>"
                                            ...
                                            <td>
                                                <div class="fw-bold"><?php echo e($fechaCita->format('d/m/Y')); ?></div>
                                                <div class="text-muted"><?php echo e(\Carbon\Carbon::parse($cita->Hora)->format('H:i')); ?></div>
                                                <small class="text-muted">Hace <?php echo e($diasPasados); ?> día<?php echo e($diasPasados != 1 ? 's' : ''); ?></small>
                                            </td>
                                            <td>
                                                <div class="text-truncate" style="max-width: 200px;"
                                                     title="<?php echo e($cita->motivo ?? 'Sin motivo especificado'); ?>">
                    ...
                    <div class="row g-3">
                            ...
                            <select class="form-select" name="estudiante_id" required>
                                ...
                                <?php $__currentLoopData = $estudiantes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estudiante): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($estudiante->Id_estudiantes); ?>" <?php echo e(old('estudiante_id') == $estudiante->Id_estudiantes ? 'selected' : ''); ?>>
                                        <?php echo e($estudiante->persona->Nombre ?? ''); ?> <?php echo e($estudiante->persona->Apellido ?? ''); ?> - <?php echo e($estudiante->Cod_estudiante); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="time" class="form-control" name="hora" 
                                   value="<?php echo e(old('hora')); ?>" required>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center p-2 bg-light rounded">
                            ...
                            <div>
                                <p class="fw-bold mb-0"><?php echo e($cita->estudiante->persona->Nombre ?? ''); ?> <?php echo e($cita->estudiante->persona->Apellido ?? ''); ?></p>
                                <small class="text-muted"><?php echo e($cita->estudiante->Cod_estudiante ?? ''); ?></small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control bg-light" rows="4" readonly><?php echo e($cita->motivo ?? 'Sin motivo especificado'); ?></textarea>
                    </div>
                    <div class="col-md-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danil\Desktop\Laravel\Yebolivia\resources\views/administrador/citasAdministrador.blade.php ENDPATH**/ ?>