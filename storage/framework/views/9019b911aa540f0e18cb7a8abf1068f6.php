                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a class="nav-link link-dark sidebar-link d-flex align-items-center gap-3"
                            data-bs-toggle="collapse" href="#submenuPersonal" role="button" aria-expanded="false">
                    ...
                    <li>
                        <a class="nav-link link-dark sidebar-link d-flex align-items-center gap-3"
                            data-bs-toggle="collapse" href="#submenuEstudiantes" role="button" aria-expanded="false">
                    ...
                    <li>
                        <a class="nav-link link-dark sidebar-link d-flex align-items-center gap-3"
                            data-bs-toggle="collapse" href="#submenuProgramas" role="button" aria-expanded="false">
                    ...
                    <!-- Pagos -->
                    <li>
                        <a href="<?php echo e(route('pagos.form')); ?>"
                            class="nav-link link-dark sidebar-link d-flex align-items-center gap-3">
                    ...
                    <li>
                        <a class="nav-link link-dark sidebar-link d-flex align-items-center gap-3"
                            data-bs-toggle="collapse" href="#submenuInventario" role="button" aria-expanded="false">
                    ...
                    <li>
                        <a class="nav-link link-dark sidebar-link d-flex align-items-center gap-3"
                            data-bs-toggle="collapse" href="#submenuComercial" role="button" aria-expanded="false">
