...
<div class="d-flex">
    ...
    <div class="sidebar-container">
        <!-- Logo -->
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="d-flex align-items-center mb-4 mb-md-0 me-md-auto link-dark text-decoration-none px-2">
        ...
        <div class="sidebar-menu">
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <!-- Dashboard -->
                <li>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link link-dark sidebar-link d-flex align-items-center gap-3">
                ...
                <li>
                    ...
                    <div class="collapse" id="submenuPersonal">
                        <ul class="nav flex-column gap-1 mt-1">
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(url('administrador/registrosAdministrador')); ?>">Administradores</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(url('administrador/profesores')); ?>">Profesores</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(url('administrador/tutoresAdministrador')); ?>">Tutores</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('usuarios.index')); ?>">Todos los Usuarios</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="submenuEstudiantes">
                        <ul class="nav flex-column gap-1 mt-1">
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('admin.estudiantes')); ?>">Ver Todos</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('registroCombinado.form')); ?>">Registrar Nuevo</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('inscripcionEstudiante.mostrar')); ?>">Inscribir a Taller</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('estudiantesActivos')); ?>">Estudiantes Activos</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('estudiantesNoActivos')); ?>">Estudiantes Inactivos</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('graduados.mostrar')); ?>">Graduados</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <!-- Horarios -->
                <li>
                    <a href="<?php echo e(route('asistencia.admin.index')); ?>" class="nav-link link-dark sidebar-link d-flex align-items-center gap-3">
                ...
                <li>
                    <a href="<?php echo e(route('horarios.index')); ?>" class="nav-link link-dark sidebar-link d-flex align-items-center gap-3">
                ...
                <!-- Pagos -->
                <li>
                    <a href="<?php echo e(route('pagos.form')); ?>" class="nav-link link-dark sidebar-link d-flex align-items-center gap-3">
                ...
                <!-- Egresos -->
                <li>
                    <a href="<?php echo e(route('egresos.index')); ?>" class="nav-link link-dark sidebar-link d-flex align-items-center gap-3">
                ...
                <li>
                    ...
                    <div class="collapse" id="submenuInventario">
                        <ul class="nav flex-column gap-1 mt-1">
                            <li>
                                <a class="nav-link link-dark submenu-item" href="<?php echo e(route('admin.componentes.inventario')); ?>">
                                    <i class="bi bi-list-ul me-2"></i>Ver Inventario
                                </a>
                            </li>
                            <li>
                                <a class="nav-link link-dark submenu-item" href="<?php echo e(route('admin.componentes.salida')); ?>">
                                    <i class="bi bi-box-arrow-right me-2"></i>Salida Componentes
                                </a>
                            </li>
                            <li>
                                <a class="nav-link link-dark submenu-item" href="<?php echo e(route('admin.componentes.entrada')); ?>">
                ...
                <!-- Sucursales -->
                <li>
                    <a href="<?php echo e(route('sucursales.index')); ?>" class="nav-link link-dark sidebar-link d-flex align-items-center gap-3">
                ...
                <!-- Publicar -->
                <li>
                    <a href="<?php echo e(route('publicaciones.index')); ?>" class="nav-link link-dark sidebar-link d-flex align-items-center gap-3">
                ...
                <li>
                    ...
                    <div class="collapse" id="submenuComercial">
                        <ul class="nav flex-column gap-1 mt-1">
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('prospectos.comercial')); ?>">Prospectos</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('estudiantesActivos')); ?>">Est. Activos</a></li>
                            <li><a class="nav-link link-dark submenu-item" href="<?php echo e(route('estudiantesNoActivos')); ?>">Est. Inactivos</a></li>
                        </ul>
                    </div>
                </li>
        ...
        <div class="sidebar-footer">
            <div class="d-flex align-items-center justify-content-between p-2 rounded-3 bg-light">
                <div class="d-flex align-items-center gap-3 flex-grow-1 overflow-hidden">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(auth()->user()->persona->Nombre ?? 'Usuario'); ?>&background=6366f1&color=fff" alt="perfil" width="40" height="40" class="rounded-circle flex-shrink-0 shadow-sm">
                    <div class="d-flex flex-column overflow-hidden" style="line-height: 1.3;">
                        <span class="fw-bold text-dark text-truncate" style="font-size: 0.9rem;"><?php echo e(auth()->user()->persona->Nombre ?? 'Usuario'); ?></span>
                        <span class="text-muted text-truncate" style="font-size: 0.75rem;"><?php echo e(ucfirst(auth()->user()->rol ?? 'Admin')); ?></span>
                    </div>
                </div>
...
</html><?php /**PATH C:\Users\DANTE\Desktop\YebSis\resources\views/administrador/baseAdministrador.blade.php ENDPATH**/ ?>