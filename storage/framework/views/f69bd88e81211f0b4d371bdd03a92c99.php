                            ...
                            <tbody>
                                <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><span class="badge bg-secondary"><?php echo e($usuario->persona->rol->Nombre_rol ?? ''); ?></span></td>
                                        <td class="pe-3 text-end">
                                            <div class="d-flex justify-content-end gap-2">
                                                <!-- Botón que abre modal -->
                                                <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editarUsuarioModal<?php echo e($usuario->Id_usuarios); ?>" title="Editar">
                                            ...
                                            <form action="<?php echo e(route('usuarios.update', $usuario->Id_usuarios)); ?>" method="POST">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header bg-primary text-white">
                                                        <h5 class="modal-title" id="editarUsuarioLabel<?php echo e($usuario->Id_usuarios); ?>"><i class="bi bi-person-gear me-2"></i>Editar Usuario</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control bg-light" value="<?php echo e($usuario->persona->rol->Nombre_rol ?? ''); ?>" disabled>
...
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DANTE\Desktop\Laravel\YebSis\resources\views/administrador/usuariosAdministrador.blade.php ENDPATH**/ ?>