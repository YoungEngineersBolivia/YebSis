<?php $__env->startSection('title', 'Mis Reparaciones'); ?>
    ...
    <div class="mobile-header bg-warning text-dark p-3 sticky-top">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                ...
                <small><?php echo e($profesor->persona->Nombre); ?> <?php echo e($profesor->persona->Apellido); ?></small>
            </div>
            <div class="text-end">
                <span class="badge bg-dark">
                    <?php echo e($asignaciones->count()); ?> Activa<?php echo e($asignaciones->count() != 1 ? 's' : ''); ?>
            ...
            <div class="card-body p-3">
                ...
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <p class="text-muted small mb-0">
                            ...
                            Asignado: <?php echo e($asignacion->Fecha_salida->format('d/m/Y H:i')); ?>

                        </p>
                        <p class="text-muted small mb-0">
                            <i class="bi bi-geo-alt-fill"></i>
                            <?php echo e($asignacion->motor->sucursal->Nombre ?? 'Sin sucursal'); ?>
                    ...
                    <div>
                        ...
                        ?>
                        <span class="badge <?php echo e($badge['class']); ?>">
                            <?php echo e($badge['icon']); ?> <?php echo e($estadoActual); ?>
                ...
                <div class="alert alert-light border-start border-warning border-4 mb-3">
                    <p class="small mb-1">
                        ...
                        <span class="badge bg-secondary"><?php echo e($asignacion->Estado_motor_salida); ?></span>
                    </p>
                    <p class="small mb-0">
                        <strong><i class="bi bi-chat-left-text-fill text-warning"></i> Motivo:</strong><br>
                        <span class="text-muted"><?php echo e($asignacion->Motivo_salida); ?></span>
                    </p>
                </div>

                <!-- Último Reporte -->
                <?php if($ultimoReporte): ?>
                <div class="alert alert-info border-start border-info border-4 mb-3">
                    ...
                    <p class="small mb-2"><?php echo e($ultimoReporte->Descripcion_trabajo); ?></p>
                    <small class="text-muted">
                        <i class="bi bi-clock-fill"></i>
                        <?php echo e($ultimoReporte->Fecha_reporte->format('d/m/Y H:i')); ?>

                    </small>
                    <?php if($ultimoReporte->Observaciones): ?>
                    <p class="small mb-0 mt-2">
                        <em class="text-muted"><?php echo e($ultimoReporte->Observaciones); ?></em>
                    </p>
                    <?php endif; ?>
                </div>
                <?php else: ?>
                ...
                <div class="text-center mb-3">
                    ...
                    <small class="badge bg-light text-dark">
                        ...
                        <?php echo e($diasTranscurridos); ?> día<?php echo e($diasTranscurridos != 1 ? 's' : ''); ?> en reparación
                    </small>
                </div>
                ...
                <div class="d-grid gap-2">
                    <button type="button" 
                            class="btn btn-info" 
                            onclick="actualizarEstado(<?php echo e($asignacion->Id_asignacion); ?>, '<?php echo e($asignacion->motor->Id_motor); ?>')">
                        <i class="bi bi-pencil-square"></i>
                        Actualizar Estado
                    </button>
                    
                    <?php if($ultimoReporte && $ultimoReporte->Estado_actual == 'Reparado'): ?>
                    <button type="button" 
                            class="btn btn-success" 
                            onclick="entregarMotor(<?php echo e($asignacion->Id_asignacion); ?>, '<?php echo e($asignacion->motor->Id_motor); ?>')">
                    ...
                    <button type="button" 
                            ...
                            onclick="verHistorialReportes(<?php echo e($asignacion->Id_asignacion); ?>)">
                        <i class="bi bi-clock-history"></i>
                        Ver Historial (<?php echo e($asignacion->reportesProgreso->count()); ?>)
                    </button>
                    <?php endif; ?>
                </div>
            </div>
...
<div class="modal fade" id="modalActualizarEstado" tabindex="-1">
    <div class="modal-dialog modal-fullscreen-sm-down">
        <div class="modal-content">
            <form action="<?php echo e(route('profesor.componentes.actualizar-estado')); ?>" method="POST" id="formActualizar">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="modalEntregarMotor" tabindex="-1">
    <div class="modal-dialog modal-fullscreen-sm-down">
        <div class="modal-content">
            <form action="<?php echo e(route('profesor.componentes.entregar-motor')); ?>" method="POST" id="formEntregar">
                <?php echo csrf_field(); ?>
...
<script>
    const asignaciones = <?php echo json_encode($asignaciones, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('profesor.baseProfesor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danil\Desktop\Laravel\Yebolivia\resources\views/profesor/motoresAsignados.blade.php ENDPATH**/ ?>