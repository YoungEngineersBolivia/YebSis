                            ...
                            <table class="table table-hover mb-0" id="programasTable">
                                ...
                                <tbody>
                                    ...
                                    <tr data-tipo="<?php echo e($programa->Tipo); ?>">
                                        <td class="ps-4 fw-semibold"><?php echo e($programa->Nombre); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <i class="far fa-clock text-muted me-1"></i><?php echo e($programa->Duracion); ?>

                                        </td>
                                        <td>
                                            <span class="text-muted"><?php echo e(Str::limit($programa->Descripcion, 50)); ?></span>
                                        </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('/administrador/baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danil\Desktop\Laravel\Yebolivia\resources\views/administrador/programasAdministrador.blade.php ENDPATH**/ ?>