...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <?php if(isset($estudiante) && $estudiante): ?>
                ...
                <a href="<?php echo e(route('estudiantes.ver', $estudiante->Id_estudiantes)); ?>" class="btn btn-outline-primary">
                    <i class="bi bi-person-circle me-2"></i>Ver Perfil
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('estudiantes.index')); ?>" class="btn btn-outline-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <p class="mb-0"><strong>Tutor:</strong> 
                                    <?php echo e($estudiante->tutor->persona->Nombre ?? ''); ?> <?php echo e($estudiante->tutor->persona->Apellido ?? 'Sin tutor'); ?>
    ...
    <?php if(!isset($estudiante)): ?>
        <div class="card shadow-sm mb-4 border-0">
            <div class="card-body">
                <form action="<?php echo e(route('evaluaciones.index')); ?>" method="GET">
    ...
    <?php if(!isset($estudiante) && $evaluaciones->hasPages()): ?>
        <div class="d-flex justify-content-center mt-4 mb-4">
            <?php echo e($evaluaciones->links('pagination::bootstrap-5')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danil\Desktop\Laravel\Yebolivia\resources\views/administrador/evaluacionesEstudiante.blade.php ENDPATH**/ ?>