        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('componentes.index')); ?>" class="btn btn-light btn-sm">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body text-center">
                                    <h3><?php echo e($entradas->where('Estado_entrada', 'Funcionando')->count()); ?></h3>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-danger text-white">
                                <div class="card-body text-center">
                                    <h3><?php echo e($entradas->where('Estado_entrada', 'Descompuesto')->count()); ?></h3>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-warning text-white">
                                <div class="card-body text-center">
                                    <h3><?php echo e($entradas->where('Estado_entrada', 'Requiere Revision')->count()); ?></h3>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body text-center">
                                    <h3><?php echo e($entradas->count()); ?></h3>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $entradas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entrada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e(\Carbon\Carbon::parse($entrada->Fecha_movimiento)->format('d/m/Y H:i')); ?></td>
                                        <td><strong><?php echo e($entrada->motor->Id_motor); ?></strong></td>
                                        <td><?php echo e($entrada->Nombre_tecnico); ?></td>
                                        <td>
                                            <?php
                                            ...
                                            <span class="badge bg-<?php echo e($badgeClass); ?>">
                                                <?php echo e($entrada->Estado_entrada); ?>

                                            </span>
                                        </td>
                                        <td><?php echo e($entrada->sucursal->Nombre); ?></td>
                                        <td>
                                            <small><?php echo e(Str::limit($entrada->Trabajo_realizado, 50)); ?></small>
                                        </td>
                                        <td>
                                            <button class="btn btn-info btn-sm" 
                                                    onclick="verDetalleEntrada(<?php echo e($entrada->Id_movimientos); ?>)">
...
function limpiarFiltros() {
    window.location.href = '<?php echo e(route('motores.entradas.index')); ?>';
}
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danil\Desktop\Laravel\Yebolivia\resources\views/componentes/historialEntradas.blade.php ENDPATH**/ ?>