<?php $__env->startSection('title', 'Registrar Administrador'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="mt-2 text-start">
        ...
        <div class="page-header d-flex flex-wrap gap-2 justify-content-between align-items-center mb-4">
            <div>
                <h1><i class="bi bi-person-plus-fill me-2"></i>Registrar Administrador</h1>
                <p class="mb-0 text-muted">Añadir un nuevo administrador al sistema</p>
            </div>
            ...
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-bottom-0 pt-4 px-4">
                        <h5 class="fw-bold text-primary mb-0">Información Personal</h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="<?php echo e(route('administrador.registrar')); ?>" method="POST">
                                    ...
                                    <div class="d-flex gap-4 pt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="genero" id="generoM"
                                                value="M" <?php echo e(old('genero', 'M') == 'M' ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="generoM">Masculino</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="genero" id="generoF"
                                                value="F" <?php echo e(old('genero') == 'F' ? 'checked' : ''); ?>>
                            ...
                            <div class="mb-4">
                                <label for="direccion_domicilio" class="form-label fw-semibold">Dirección
                                    Domiciliaria</label>
...
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DANTE\Desktop\YebSis\resources\views//administrador/registrosAdministradores.blade.php ENDPATH**/ ?>