                    ...
                    <?php $__currentLoopData = $publicaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $publicacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card"
                            ...
                            <?php if($publicacion->Descripcion): ?>
                                <p style="margin:0; font-size:15px; color:#444; line-height:1.6;"><?php echo e($publicacion->Descripcion); ?></p>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
        ...
        function generateModalsHTML() {
            ...
            publicaciones.forEach((pub, index) => {
                ...
                const imagenHTML = tieneImagen
                    ? `<img src="<?php echo e(asset('storage')); ?>/${pub.Imagen}" style="width:100%; max-height:380px; object-fit:cover; border-radius:10px; margin-bottom:16px; display:block;">`
                    : '';
