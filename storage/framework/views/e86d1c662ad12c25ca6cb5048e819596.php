                ...
                <?php if(isset($estudiantes) && $estudiantes->count() > 0): ?>
                    <?php $__currentLoopData = $estudiantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estudiante): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 student-item">
                            <div class="card h-100 shadow-sm border-0 student-card p-3"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="flex-shrink-0">
                                        <img src="<?php echo e(auto_asset('img/' . ($estudiante->persona?->Genero === 'M' ? 'boy.png' : 'girls.png'))); ?>"
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="mb-1 fw-bold text-dark text-wrap student-name" style="word-break: break-word;">
                                            <?php echo e($estudiante->persona?->Nombre); ?> <?php echo e($estudiante->persona?->Apellido); ?>

                                        </h5>
                                        <p class="mb-1 text-muted small text-truncate student-program">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('profesor.baseProfesor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DANTE\Desktop\YebSis\resources\views/profesor/listadoAlumnos.blade.php ENDPATH**/ ?>