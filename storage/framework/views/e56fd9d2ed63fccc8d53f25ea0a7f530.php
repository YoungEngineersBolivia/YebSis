                                    ...
                                    <td class="pe-3 text-end">
                                        <div class="d-flex gap-2 justify-content-end">
                                            <button class="btn btn-sm btn-outline-primary" title="Editar" data-bs-toggle="modal"
                                                data-bs-target="#modalEditarSucursal" data-id="<?php echo e($sucursal->Id_sucursales); ?>"
                                            ...
                                            <button class="btn btn-sm btn-outline-danger" title="Eliminar"
                                                ...
                                                data-id="<?php echo e($sucursal->Id_sucursales); ?>" data-nombre="<?php echo e($sucursal->Nombre); ?>">
...
<?php echo $__env->make('administrador.baseAdministrador', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DANTE\Desktop\YebSis\resources\views/administrador/sucursalesAdministrador.blade.php ENDPATH**/ ?>