    ...
    <div class="mobile-header bg-primary text-white p-3 sticky-top">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                ...
                <small><?php echo e($profesor->persona->Nombre); ?></small>
            </div>
            <div class="text-end">
                <span class="badge bg-light text-primary">
                    <?php echo e($motores->count()); ?> Motores
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="p-3">
        <div id="listaMotores">
            ...
            <div class="card mb-3 shadow-sm motor-card" 
                 data-id="<?php echo e($motor->Id_motor); ?>" 
                ...
                <div class="card-body p-3">
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            <h6 class="mb-1">
                                ...
                                <strong><?php echo e($motor->Id_motor); ?></strong>
                            </h6>
                        ...
                        <div>
                            ...
                            <span class="badge <?php echo e($badge['class']); ?>">
                                <?php echo e($badge['icon']); ?> <?php echo e($motor->Estado); ?>
                    ...
                    <!-- Observaciones -->
                    <?php if($motor->Observacion): ?>
                    <div class="alert alert-light py-2 mb-3">
                        <p class="small mb-0">
                            <i class="bi bi-chat-left-text text-muted"></i>
                            <strong>Observación:</strong><br>
                            <span class="text-muted"><?php echo e($motor->Observacion); ?></span>
                        </p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-grid">
                        <button type="button" 
                                ...
                                data-motor-id="<?php echo e($motor->Id_motores); ?>"
                                data-motor-display="<?php echo e($motor->Id_motor); ?>"
                                data-motor-estado="<?php echo e($motor->Estado); ?>">
...
<div class="modal fade" id="modalSolicitarSalida" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="<?php echo e(route('profesor.componentes.solicitar-salida')); ?>" method="POST" id="formSolicitud">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('profesor.baseProfesor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danil\Desktop\Laravel\Yebolivia\resources\views/profesor/inventarioProfesor.blade.php ENDPATH**/ ?>