...
@section('content')
                    ...
                    <form method="POST" action="{{ route('claseprueba.store') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="Nombre_Estudiante" id="modalNombreEstudiante"
                                    class="form-control form-control-lg" placeholder="Nombre completo" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <input type="date" name="Fecha_clase" class="form-control" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">
                                ...
                                <input type="time" name="Hora_clase" class="form-control" value="15:00" required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold">
    ...
    <div class="modal fade" id="modalVerClasePrueba" tabindex="-1" aria-labelledby="modalVerClasePruebaLabel"
        aria-hidden="true">
    ...
    <!-- Modal para registrar nuevo prospecto -->
    <div class="modal fade" id="modalNuevoProspecto" tabindex="-1" aria-labelledby="modalNuevoProspectoLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="modalNuevoProspectoLabel">
                ...
                <div class="modal-body p-4">
                    <form method="POST" action="{{ route('prospectos.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="telefono" class="form-control" placeholder="Ej: 77712345" required>
                        </div>
