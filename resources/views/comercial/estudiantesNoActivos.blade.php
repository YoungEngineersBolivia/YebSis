                            ...
                            @foreach($mesesDisponibles as $mes)
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('estudiantesNoActivos', ['from' => $mes->mes . '-01', 'to' => date('Y-m-t', strtotime($mes->mes . '-01'))]) }}">
                                        {{ $mes->mes_nombre }}
        ...
        <div class="card-soft p-3">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                ...
                <div class="btn-group gap-2">
                    <a href="{{ route('estudiantesNoActivos.exportar', request()->all()) }}" class="btn btn-success btn-sm">
