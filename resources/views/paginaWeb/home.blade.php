    ...
    <div class="container">
        <div class="header-content">
            ...
            <nav class="nav-links" id="mainNavLinks">
                ...
                <img src="{{Vite::asset('public/img/recognized_by.png')}}" alt="Reconocimiento" width="200px" class="me-2">
        ...
        <section class="hero">
            ...
            <div class="hero-container">
                ...
                <div class="hero-visual">
                    <img src="{{ Vite::asset('public/img/Logo_sign.png') }}" alt="Logo YE Bolivia" width="250px" class="me-2">
                </div>
                ...
                <div class="contact-section">
                    ...
                    <div class="contact-buttons">
                        ...
                        <a href="#" class="btn-contact btn-register" onclick="openContactModal()">
                            <img src="{{ Vite::asset('public/img/registro.png') }}" alt="Registro">
                    ...
                    @if($programa->Tipo === 'programa')
                        ...
                        <div class="program-card" style="background: {{ $bgColor }}20; border-radius: 18px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); border-top: 6px solid {{ $bgColor }};">
                            <div class="program-icon" style="text-align:center; margin-bottom:10px;">
                                ...
                                @else
                                    <img src="{{ Vite::asset('public/img/Logo_sign.png') }}" 
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-logo">
                    <div>
                        <img src="{{ Vite::asset('public/img/logo_blanco.png') }}" alt="Logo YE Bolivia" width="250px" class="me-2">
