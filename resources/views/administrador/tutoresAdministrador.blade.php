                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="searchTutor" class="form-control border-start-0 ps-0" name="search"
                                placeholder="Buscar por nombre, apellido o celular..." value="{{ $search ?? '' }}" data-table-filter="tutorsTable">
                        ...
                        <tbody>
                            @foreach ($tutores as $tutor)
                                <tr>
                                    ...
                                    <td><span class="badge bg-light text-dark border">{{ $tutor->Parentesco ?? '—' }}</span></td>
