                                            ...
                                            <tr data-tipo="{{ $programa->Tipo }}">
                                                <td class="ps-4 fw-semibold">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <small
                                                            class="text-muted">{{ Str::limit($programa->Descripcion, 40) }}</small>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-sm btn-outline-primary"
                                                        ...
                                                        <span
                                                            class="badge bg-primary rounded-pill">{{ $programa->modelos_count ?? 0 }}</span>
                                                    </button>
                                                </td>
                                                <td class="text-center">
                    ...
                    <div class="col-12 program-card-wrapper" data-tipo="{{ $programa->Tipo }}">
                        <div class="program-card">
                            ...
                            <div class="program-card-actions">
                                ...
                                <form action="{{ route('programas.destroy', $programa->Id_programas) }}" method="POST"
        ...
        <div class="modal fade" id="editarProgramaModal{{ $programa->Id_programas }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('programas.update', $programa->Id_programas) }}" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="duracion" value="{{ $programa->Duracion }}"
                                        required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="rango_edad"
                                        value="{{ $programa->Rango_edad }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="duracion"
                                        value="{{ $programa->Duracion ?? '' }}" placeholder="Ej: 3 meses, 12 semanas, 40 horas">
                                    <small class="text-muted">
                            ...
                            <div class="mb-3">
                                ...
                                @if($programa->Imagen)
                                    <div class="mt-3 p-3 bg-light rounded">
                                        ...
                                        <img src="{{ asset('storage/' . $programa->Imagen) }}" class="img-thumbnail"
                                ...
                                <div class="list-group">
                                    @foreach($modelosPrograma as $modelo)
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <form
                                                action="{{ route('modelos.destroy', [$programa->Id_programas, $modelo->Id_modelos]) }}"
                                                method="POST" style="display:inline;"
