...
<div class="mt-2">
    ...
    <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a href="{{ route('estudiantes.exportarPDF') }}" class="btn btn-sm btn-danger">
                <i class="fas fa-file-pdf me-2"></i>PDF
            </a>
            <a href="{{ route('registroCombinado.registrar') }}" class="btn btn-sm btn-primary">
        ...
        <div class="card-body">
            <form action="{{ route('estudiantes.index') }}" method="GET" id="filtrosForm">
                <div class="row g-3">
                    ...
                    {{-- Botones de acción (Eliminados los antiguos redundantes) --}}
                </div>
            </form>
        </div>
    </div>
