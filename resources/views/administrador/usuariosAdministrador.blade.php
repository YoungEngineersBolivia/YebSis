                            ...
                            <tbody>
                                @foreach($usuarios as $usuario)
                                    <tr>
                                        ...
                                        <td><span class="badge bg-secondary">{{ $usuario->persona->rol->Nombre_rol ?? '' }}</span>
                                        </td>
                                        <td class="pe-3 text-end">
                                            <div class="d-flex justify-content-end gap-2">
                                                <!-- Botón que abre modal -->
                                                <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                                                    data-bs-target="#editarUsuarioModal{{ $usuario->Id_usuarios }}" title="Editar">
                                    ...
                                    <!-- Modal de edición -->
                                    <div class="modal fade" id="editarUsuarioModal{{ $usuario->Id_usuarios }}" tabindex="-1"
                                        aria-labelledby="editarUsuarioLabel{{ $usuario->Id_usuarios }}" aria-hidden="true">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control bg-light"
                                                                value="{{ $usuario->persona->rol->Nombre_rol ?? '' }}" disabled>
