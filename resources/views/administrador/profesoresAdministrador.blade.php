                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                <input id="searchInput" type="text" class="form-control border-start-0 ps-0"
                                    ...
                                    value="{{ request()->search }}" data-table-filter="teachersTable">
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <table class="table table-striped table-hover align-middle mb-0" id="teachersTable">
                            ...
                            <tbody>
                                @foreach ($profesores as $profesor)
                                        ...
                                        <td class="pe-3 text-end actions-container">
                                            <div class="action-buttons">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-info" data-bs-toggle="modal"
                                                    data-bs-target="#verProfesorModal{{ $profesor->Id_profesores }}"
                                                    title="Ver detalles">
                                    ...
                                    <!-- Modal Ver Profesor -->
                                    <div class="modal fade" id="verProfesorModal{{ $profesor->Id_profesores }}" tabindex="-1"
                                        aria-hidden="true">
                                    ...
                                    <div class="modal fade" id="editarProfesorModal{{ $profesor->Id_profesores }}" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('profesores.update', $profesor->Id_profesores) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="row g-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" name="nombre" class="form-control"
                                                                    value="{{ $profesor->persona->Nombre ?? '' }}" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label fw-bold">Apellido</label>
                                                                <input type="text" name="apellido" class="form-control"
                                                                    value="{{ $profesor->persona->Apellido ?? '' }}" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label fw-bold">Celular</label>
                                                                <input type="text" name="celular" class="form-control"
                                                                    value="{{ $profesor->persona->Celular ?? '' }}">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label fw-bold">Correo electrónico</label>
                                                                <input type="email" name="correo" class="form-control"
                                                                    value="{{ $profesor->usuario->Correo ?? '' }}" required>
                                                            </div>
                                                            <div class="col-md-6">
