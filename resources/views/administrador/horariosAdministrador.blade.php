...
@section('content')
        ...
        <form action="{{ route('horarios.index') }}" method="GET" id="searchForm">
          <div class="row g-3">
            ...
            <div class="col-12 col-md-6">
              <label class="form-label small fw-semibold">Buscar estudiante</label>
            ...
            {{-- Filtro Profesor --}}
            <div class="col-6 col-md-3">
              <label class="form-label small fw-semibold">Profesor</label>
              <select class="form-select" name="profesor">
                <option value="">Todos los profesores</option>
                @foreach($profesores as $p)
                  <option value="{{ $p->Id_profesores }}"
                    {{ ($filtroProfesor ?? '') == $p->Id_profesores ? 'selected' : '' }}>
            ...
            <div class="col-6 col-md-2">
              <label class="form-label small fw-semibold">Hora desde</label>
              <input type="time" class="form-control" name="hora_desde"
                value="{{ $filtroHoraDesde ?? '' }}">
            </div>

            {{-- Filtro Hora hasta --}}
            <div class="col-6 col-md-2">
              <label class="form-label small fw-semibold">Hora hasta</label>
              <input type="time" class="form-control" name="hora_hasta"
            ...
            <div class="col-12 col-md-4 d-flex align-items-end gap-2">
              ...
              <a href="{{ route('horarios.index') }}" class="btn btn-outline-secondary flex-fill">
          ...
          <small class="text-muted mt-2 d-block">
            @if($hayFiltros)
              Mostrando <strong>{{ $horarios->total() }}</strong> resultado(s) con los filtros aplicados
            @else
              Mostrando todos los <strong>{{ $horarios->total() }}</strong> horarios
            @endif
          </small>
    ...
    @if($horarios->isEmpty())
      <div class="card shadow-sm border-0">
        <div class="card-body text-center py-5">
          ...
          <h5 class="text-muted">No se encontraron horarios con los filtros aplicados.</h5>
          <a href="{{ route('horarios.index') }}" class="btn btn-outline-secondary mt-2">
        ...
        <form method="POST" action="{{ route('horarios.store') }}">
          ...
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title" id="modalCrearLabel">
              <i class="bi bi-calendar-plus me-2"></i>Asignar nuevo horario
            </h5>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      // Inicializar búsquedas en modales
      setupDynamicSearch(
      ...
      // ---- Agregar/quitar filas de horario en modal crear ----
      ...
      // ---- Modal editar: cargar datos al abrir ----
      ...
      if (modalEditar) {
        modalEditar.addEventListener('show.bs.modal', function (event) {
          ...
          if (est) {
            ...
            actualizarInfoEstudianteDesdeData(
              fakeOption,
              document.getElementById('Id_profesores_editar'),
              document.getElementById('programa_info_editar'),
              document.getElementById('sucursal_info_editar'),
