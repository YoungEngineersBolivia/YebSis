                                ...
                                <table class="table table-hover align-middle" id="tablaProximas">
                                    ...
                                    <tbody>
                                        @foreach($citasProximas as $cita)
                                            ...
                                            @endphp
                                            <tr class="cita-card {{ $claseEstado }}" data-estado="{{ $cita->estado }}"
                                                ...
                                                <td>
                                                    ...
                                                    <div class="text-muted">{{ \Carbon\Carbon::parse($cita->Hora)->format('H:i') }}
                                                    </div>
                                                    ...
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        @if($cita->estado == 'pendiente')
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-outline-danger"
                                                                onclick="cancelarCita({{ $cita->Id_citas }})" title="Cancelar cita">
                                        ...
                                        @foreach($citasPasadas as $cita)
                                            ...
                                            <tr class="cita-card {{ $claseEstado }}" data-estado="{{ $cita->estado }}"
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-muted">Hace {{ $diasPasados }}
                                                        día{{ $diasPasados != 1 ? 's' : '' }}</small>
                                                </td>
                                                <td>
                                                    <div class="text-truncate" style="max-width: 200px;"
                                                        title="{{ $cita->motivo ?? 'Sin motivo especificado' }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control bg-light" rows="4"
                                    readonly>{{ $cita->motivo ?? 'Sin motivo especificado' }}</textarea>
                            </div>
                            <div class="col-md-6">
